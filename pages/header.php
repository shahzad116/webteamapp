<nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <img alt="image" class="" src="img/logo/logo.png" width="200"/>
                    ...
                    <li class="active">
                        <a href="create-company.php"><i class="fa fa-th-large"></i> <span class="nav-label">Create Company</span></a>
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to Web Team App</span>
                </li>
                <li class="dropdown">
